        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitCostPrice = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
                    UnitSellingPrice = table.Column<decimal>(type: "decimal(18,4)", precision: 18, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_Partners_PartnerId",
                        column: x => x.PartnerId,
                        principalTable: "Partners",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_InventoryTransactions_Partners_PartnerId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductTags_TagValues_TagValueId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_PartnerId",
                table: "InventoryTransactions",
                column: "PartnerId");

            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_PartnerId1",
                table: "InventoryTransactions",
                column: "PartnerId1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTags_TagValueId",
                table: "ProductTags",
                column: "TagValueId");

            migrationBuilder.CreateIndex(
                name: "IX_TagValues_TagId_Value",
                table: "TagValues",
